...
func TestGetClient(t *testing.T) {
	...
	_, err = osinStorage.GetClient("834681386231.mygluk.it", c.Request().(*http.Request))
...
func TestAccessDataStorage(t *testing.T) {
	...
	osinStorage := NewOsinAppEngineStore(c.Request().(*http.Request))
	client, err := osinStorage.GetClient("834681386231.mygluk.it", c.Request().(*http.Request))
